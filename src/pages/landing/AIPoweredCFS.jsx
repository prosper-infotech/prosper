        ...
        <div className="relative flex flex-col">
          <div className="flex items-center">
            <div className="max-w-6xl mx-auto px-6 pt-8 sm:pt-10 lg:pt-12 pb-3 sm:pb-4 w-full">
              <Reveal className="flex flex-col items-center text-center gap-2 sm:gap-3 lg:items-start lg:text-left max-w-xl mx-auto lg:mx-0 rounded-2xl bg-navy/60 backdrop-blur-md border border-white/10 p-5 sm:p-6 md:bg-transparent md:border-0 lg:bg-transparent lg:backdrop-blur-none lg:border-0 lg:p-0">
