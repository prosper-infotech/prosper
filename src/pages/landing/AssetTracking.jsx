        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-[1fr_0.95fr] gap-12 items-center">
          <Reveal className="flex flex-col gap-5">
            ...
            <h1 className="text-primary text-3xl md:text-4xl leading-tight">
              Prosper <span className="text-gold-dark">Asset Tracking</span>
            </h1>
            <p className="text-xl md:text-2xl font-heading font-bold leading-snug text-primary">
            ...
            <span className="inline-flex self-start items-center gap-2 rounded-full bg-gold/20 border border-gold-dark/40 px-4 py-2 text-sm font-semibold text-primary-dark">
